...
cClass = [
    ...
    CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE,   # 210 ..........
    ...
    CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE,   # 240 ..........
    CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.EOF,                                        # 250 .....
]
...
# 0: ST.MAIN  - main scanning loop
    [-TK.EOF,  TK.BAD,  ST.IDNT, ST.INT,  ST.IDNT, TK.SEMI, TK.COMA, ST.DOT,  ST.COLN, ST.MNUS, ST.PLUS, TK.STAR, ST.SLSH, TK.BSLH, ST.PCT,  TK.EXPN, ST.EQLS,-ST.SCMT,-ST.SQT1,-ST.DQOT, ST.EXCL, TK.QSTN, TK.AMPS,-ST.CURR, TK.ATS,  TK.BAR,  ST.GTR2, ST.LSS2, TK.LBRC, TK.RBRC, TK.LPRN, TK.RPRN, TK.LBRK, TK.RBRK, TK.BAD,  TK.EOL, ST.WHT],
...
# 3: ST.FLOT - extract floats (& currency)
    [-TK.FLOT, -TK.FLOT,TK.DUR,  ST.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT, TK.PCT, -TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT],
...
# 6: ST.SQOT - single-quoted literal (skip past ")
    [TK.ERR,   ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT,-TK.QUOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT],
# 7: ST.DQOT - double-quoted literal (skip past ')
    [TK.ERR,   ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT,-TK.QUOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT, ST.DQOT],
# 8: ST.CMCT- skip C-style multi-line comments
    [-TK.ERR, -ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.STAR,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT],
# 9: ST.SLSH- forward slash disambiguator (c-style)
    [-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-ST.CMCT,-ST.SCMT,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH,-TK.SLSH],
# 10: ST.STAR- asterisk disambiguator (in c-style ML comment)
    [-TK.ERR, -ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-TK.WHT, -ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT,-ST.CMCT],
# 11: ST.PMCT- skip Python-style multi-line comments
    [-TK.ERR, -ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.SQT3,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT],
# 12: ST.SQT1- skip Python-style multi-line comments
    [-TK.ERR,  ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT,-ST.SQT1, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT, ST.SQOT],
# 12: ST.SQT2- skip Python-style multi-line comments
    [-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-ST.PMCT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT,-TK.QUOT],
# 14: ST.SQT3- skip Python-style multi-line comments
    [-TK.ERR, -ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.SQT4,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT],
# 15: ST.SQT4- skip Python-style multi-line comments
    [-TK.ERR, -ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-TK.WHT, -ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT,-ST.PMCT],
# 16: ST.GTR2- > disambiguation
    [-TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR,  TK.GTE, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR,  TK.RBAR, TK.GTR2, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR],
...
# 20: ST.COLN- : disambiguation
    [-TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, TK.CLN2, TK.COMN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, TK.COEQ, -TK.COLN, -TK.COLN, -TK.COLN, TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN, -TK.COLN],
...
# 22: ST.MNUS- - disambiguation
    [-TK.MNUS,-TK.MNUS,-TK.MNUS, ST.INT, -TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.MNU2,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.MNEQ,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.RARR,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS],
...
# 26: ST.CURR - extract floats (& currency)
    [-TK.FLOT, -TK.FLOT,TK.DUR,  ST.CURR,-TK.FLOT,-TK.FLOT,-TK.FLOT, ST.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT, TK.PCT, -TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT,-TK.FLOT],
]
