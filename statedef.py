...
cClass = [
    ...
    CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.NONE, CL.EMPTY, CL.NONE,  # 240 ........ø.
...
tkState = [
    ...
    # CL.EOF,  CL.NONE, CL.LETR, CL.DIGT, CL.USCR, CL.SEMI, CL.COMA, CL.DOT,  CL.COLN, CL.MNUS, CL.PLUS, CL.STAR, CL.SLSH, CL.BSLH, CL.PCT,  CL.EXPN, CL.EQLS, CL.LBS,  CL.SQOT, CL.DQOT, CL.EXCL, CL.QSTN, CL.AMPS, CL.DLRS, CL.ATS,  CL.BAR,  CL.GTR,  CL.LESS, CL.LBRC, CL.RBRC, CL.LPRN, CL.RPRN, CL.LBRK, CL.RBRK, CL.TLDE, CL.EMPTY CL.NEWLN,CL.WHITE,
# 0: ST.MAIN  - main scanning loop
    [-TK.EOF,  TK.BAD,  ST.IDNT, ST.INT,  ST.IDNT, TK.SEMI, TK.COMA, ST.DOT,  ST.COLN, ST.MNUS, ST.PLUS, TK.STAR, ST.SLSH, TK.BSLH, ST.PCT,  TK.EXPN, ST.EQLS,-ST.SCMT,-ST.SQT1,-ST.DQOT, ST.EXCL, TK.QSTN, TK.AMPS,-ST.CURR, TK.ATS,  TK.BAR,  ST.GTR2, ST.LSS2, TK.LBRC, TK.RBRC, TK.LPRN, TK.RPRN, TK.LBRK, TK.RBRK, TK.BAD, TK.EMPTY, TK.EOL, ST.WHT],
...
# 5: ST.SCMT- skip single-line comments (c- or python-style)
    [-TK.WHT, -ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.SCMT,-ST.WHT,-ST.WHT, -ST.SCMT],
...
# 16: ST.GTR2- > disambiguation
    [-TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR,  TK.GTE, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR,  TK.RBAR, TK.GTR2, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR, -TK.GTR,-TK.GTR, -TK.GTR],
...
# 11: ST.BAR-  | disambiguation
    [-TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR,  TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR,  TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR,  TK.BAR2, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR, -TK.BAR],
# 22: ST.MNUS- - disambiguation
    [-TK.MNUS,-TK.MNUS,-TK.MNUS, ST.INT, -TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.MNU2,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.MNEQ,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS, TK.RARR,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS,-TK.MNUS],
