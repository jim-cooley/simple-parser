...
def _gtr__str_int(l_value, r_value):
    return l_value > c_to_int(r_value)


def _gtr__any_str(l_value, r_value):
    return c_to_int(l_value) > r_value
...
_boolean_dispatch_table = {
    ...
    TK.GTR: [
        ...
        [_gtr__any_any,    _gtr__any_any,    _gtr__any_any,    _gtr__any_any,    _gtr__str_int,    _gtr__any_any,    _gtr__any_any,    _invalid_gtr],   # int      
        ...
        [_gtr__any_str,    _gtr__any_any,    _gtr__any_any,    _gtr__any_any,    _gtr__any_any,    _gtr__any_any,    _gtr__any_any,    _invalid_gtr],   # str      
