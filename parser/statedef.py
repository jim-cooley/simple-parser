...
# 1: ST.IDENT - extract identifiers
    [-TK.IDENT, -TK.IDENT, ST.IDNT, ST.IDNT, ST.IDNT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT, -TK.IDENT],

# 2: ST.INT   - extract integers
    [-TK.INT, -TK.INT,  TK.DUR,  ST.INT, -TK.INT, -TK.INT, -TK.INT,  ST.FLOT,-TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT,  TK.PCT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT, -TK.INT,-TK.INT, -TK.INT],
...
# 25: ST.TIME - extract time values (DISABLED)
